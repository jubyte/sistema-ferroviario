...
<body>
    ...
    <main class="conteudo">
        ...
        <section class="resumo-superior">

            <div class="cartao-sensores">
        ...
        <section class="painel-monitoramento">
            ...
            <div class="area-monitoramento"></div>

        </section>

        <section class="painel-trens">
            ...
            <div class="lista-trens">
                <div class="item-trem"></div>
                <div class="item-trem"></div>
                <div class="item-trem"></div>
                <div class="item-trem"></div>
                <div class="item-trem"></div>
